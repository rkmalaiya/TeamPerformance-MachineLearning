...
import org.hadoop.vector.VectorForIndividuals;
...
//		
		...
		VectorForIndividuals vector = new VectorForIndividuals();		
		...
		try {
			...
			String allProjects = "hadoop-common-project,hadoop-hdfs-project,hadoop-mapreduce-project,hadoop-yarn-project,pig,hive,hbase";
		...
		try {
			...
			cluster.startClustering("vectors", "vectors_group_canopy", "vectors_group_kmeansCluster");
